...
[**BAB 1: PEMASANGAN PERANGKAT JARINGAN**](#bab-1-pemasangan-perangkat-jaringan)
    [1.1 Pengertian Perangkat Jaringan](#11-pengertian-perangkat-jaringan)
    [1.2 Jenis-Jenis Perangkat Jaringan](#12-jenis-jenis-perangkat-jaringan)
    [1.3 Standar Pengkabelan Jaringan](#13-standar-pengkabelan-jaringan)
    [1.4 Langkah Pemasangan Perangkat Jaringan](#14-langkah-pemasangan-perangkat-jaringan)
    [1.5 Praktikum Pemasangan Jaringan](#15-praktikum-pemasangan-jaringan)
    [1.6 Ringkasan](#16-ringkasan)
    [1.7 Soal Latihan](#17-soal-latihan)

[**BAB 2: PENGGANTIAN PERANGKAT JARINGAN**](#bab-2-penggantian-perangkat-jaringan)
    [2.1 Identifikasi Kebutuhan Penggantian Perangkat](#21-identifikasi-kebutuhan-penggantian-perangkat)
    [2.2 Prosedur Penggantian Perangkat Jaringan](#22-prosedur-penggantian-perangkat-jaringan)
    [2.3 Troubleshooting Perangkat Jaringan](#23-troubleshooting-perangkat-jaringan)
    [2.4 Praktikum Penggantian Perangkat](#24-praktikum-penggantian-perangkat)
    [2.5 Ringkasan](#25-ringkasan)
    [2.6 Soal Latihan](#26-soal-latihan)

[**BAB 3: KONSEP, KONFIGURASI DAN PENGUJIAN VLAN**](#bab-3-konsep-konfigurasi-dan-pengujian-vlan)
    [3.1 Pengertian VLAN](#31-pengertian-vlan)
    [3.2 Manfaat dan Karakteristik VLAN](#32-manfaat-dan-karakteristik-vlan)
    [3.3 Jenis-Jenis VLAN](#33-jenis-jenis-vlan)
    [3.4 VLAN Tagging dan Trunking](#34-vlan-tagging-dan-trunking)
    [3.5 Konfigurasi VLAN pada Switch](#35-konfigurasi-vlan-pada-switch)
    [3.6 Pengujian VLAN](#36-pengujian-vlan)
    [3.7 Praktikum Konfigurasi VLAN](#37-praktikum-konfigurasi-vlan)
    [3.8 Ringkasan](#38-ringkasan)
    [3.9 Soal Latihan](#39-soal-latihan)

[**BAB 4: KONFIGURASI ROUTING**](#bab-4-konfigurasi-routing)
    [4.1 Pengertian Routing](#41-pengertian-routing)
    [4.2 Proses Routing](#42-proses-routing)
    [4.3 Jenis-Jenis Routing](#43-jenis-jenis-routing)
    [4.4 Routing Statis](#44-routing-statis)
    [4.5 Routing Dinamis](#45-routing-dinamis)
    [4.6 Protokol Routing Dinamis (RIP, OSPF, EIGRP)](#46-protokol-routing-dinamis-rip-ospf-eigrp)
    [4.7 Praktikum Konfigurasi Routing Statis](#47-praktikum-konfigurasi-routing-statis)
    [4.8 Praktikum Konfigurasi Routing Dinamis RIP](#48-praktikum-konfigurasi-routing-dinamis-rip)
    [4.9 Ringkasan](#49-ringkasan)
    [4.10 Soal Latihan](#410-soal-latihan)

[**BAB 5: PERMASALAHAN DAN PERBAIKAN KONFIGURASI ROUTING**](#bab-5-permasalahan-dan-perbaikan-konfigurasi-routing)
    [5.1 Analisis Permasalahan Routing](#51-analisis-permasalahan-routing)
    [5.2 Jenis-Jenis Masalah Routing](#52-jenis-jenis-masalah-routing)
    [5.3 Metode Troubleshooting Routing](#53-metode-troubleshooting-routing)
    [5.4 Perbaikan Konfigurasi Routing](#54-perbaikan-konfigurasi-routing)
    [5.5 Praktikum Troubleshooting Routing](#55-praktikum-troubleshooting-routing)
    [5.6 Ringkasan](#56-ringkasan)
    [5.7 Soal Latihan](#57-soal-latihan)

[**BAB 6: KONFIGURASI NAT (NETWORK ADDRESS TRANSLATION)**](#bab-6-konfigurasi-nat-network-address-translation)
    [6.1 Pengertian NAT](#61-pengertian-nat)
    [6.2 Fungsi dan Manfaat NAT](#62-fungsi-dan-manfaat-nat)
    [6.3 Jenis-Jenis NAT](#63-jenis-jenis-nat)
    [6.4 Cara Kerja NAT](#64-cara-kerja-nat)
    [6.5 Konfigurasi NAT pada Router](#65-konfigurasi-nat-pada-router)
    [6.6 Praktikum Konfigurasi NAT](#66-praktikum-konfigurasi-nat)
    [6.7 Ringkasan](#67-ringkasan)
    [6.8 Soal Latihan](#68-soal-latihan)

[**BAB 7: PERMASALAHAN INTERNET GATEWAY DAN PERBAIKAN NAT**](#bab-7-permasalahan-internet-gateway-dan-perbaikan-nat)
    [7.1 Pengertian Internet Gateway](#71-pengertian-internet-gateway)
    [7.2 Permasalahan pada Internet Gateway](#72-permasalahan-pada-internet-gateway)
    [7.3 Analisis Masalah NAT](#73-analisis-masalah-nat)
    [7.4 Perbaikan Konfigurasi NAT](#74-perbaikan-konfigurasi-nat)
    [7.5 Praktikum Troubleshooting NAT dan Gateway](#75-praktikum-troubleshooting-nat-dan-gateway)
    [7.6 Ringkasan](#76-ringkasan)
    [7.7 Soal Latihan](#77-soal-latihan)

[**BAB 8: KONFIGURASI PROXY SERVER**](#bab-8-konfigurasi-proxy-server)
    [8.1 Pengertian Proxy Server](#81-pengertian-proxy-server)
    [8.2 Fungsi dan Manfaat Proxy Server](#82-fungsi-dan-manfaat-proxy-server)
    [8.3 Jenis-Jenis Proxy Server](#83-jenis-jenis-proxy-server)
    [8.4 Cara Kerja Proxy Server](#84-cara-kerja-proxy-server)
    [8.5 Konfigurasi Proxy Server (Squid)](#85-konfigurasi-proxy-server-squid)
    [8.6 Praktikum Konfigurasi Proxy Server](#86-praktikum-konfigurasi-proxy-server)
    [8.7 Ringkasan](#87-ringkasan)
    [8.8 Soal Latihan](#88-soal-latihan)

[**BAB 9: PERMASALAHAN DAN PERBAIKAN PROXY SERVER**](#bab-9-permasalahan-dan-perbaikan-proxy-server)
    [9.1 Analisis Permasalahan Proxy Server](#91-analisis-permasalahan-proxy-server)
    [9.2 Jenis-Jenis Masalah Proxy Server](#92-jenis-jenis-masalah-proxy-server)
    [9.3 Troubleshooting Proxy Server](#93-troubleshooting-proxy-server)
    [9.4 Perbaikan Konfigurasi Proxy Server](#94-perbaikan-konfigurasi-proxy-server)
    [9.5 Praktikum Troubleshooting Proxy](#95-praktikum-troubleshooting-proxy)
    [9.6 Ringkasan](#96-ringkasan)
    [9.7 Soal Latihan](#97-soal-latihan)

[**BAB 10: KONFIGURASI DAN PENGUJIAN MANAJEMEN BANDWIDTH**](#bab-10-konfigurasi-dan-pengujian-manajemen-bandwidth)
    [10.1 Pengertian Bandwidth](#101-pengertian-bandwidth)
    [10.2 Konsep Manajemen Bandwidth](#102-konsep-manajemen-bandwidth)
    [10.3 Teknik Manajemen Bandwidth](#103-teknik-manajemen-bandwidth)
    [10.4 Alat Manajemen Bandwidth](#104-alat-manajemen-bandwidth)
    [10.5 Konfigurasi Manajemen Bandwidth (HTB/TC)](#105-konfigurasi-manajemen-bandwidth-htbtc)
    [10.6 Pengujian Manajemen Bandwidth](#106-pengujian-manajemen-bandwidth)
    [10.7 Praktikum Manajemen Bandwidth](#107-praktikum-manajemen-bandwidth)
    [10.8 Ringkasan](#108-ringkasan)
    [10.9 Soal Latihan](#109-soal-latihan)

[**BAB 11: KONFIGURASI DAN PENGUJIAN LOAD BALANCING**](#bab-11-konfigurasi-dan-pengujian-load-balancing)
    [11.1 Pengertian Load Balancing](#111-pengertian-load-balancing)
    [11.2 Tujuan dan Manfaat Load Balancing](#112-tujuan-dan-manfaat-load-balancing)
    [11.3 Metode Load Balancing](#113-metode-load-balancing)
    [11.4 Algoritma Load Balancing](#114-algoritma-load-balancing)
    [11.5 Konfigurasi Load Balancing pada Router](#115-konfigurasi-load-balancing-pada-router)
    [11.6 Pengujian Load Balancing](#116-pengujian-load-balancing)
    [11.7 Praktikum Load Balancing](#117-praktikum-load-balancing)
    [11.8 Ringkasan](#118-ringkasan)
    [11.9 Soal Latihan](#119-soal-latihan)
